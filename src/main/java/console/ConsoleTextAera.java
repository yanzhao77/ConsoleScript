...
//        println(this.getText() + "is ready")
    ...
    public void shellInit() {
        if (ParserName.equals("jython")) {
            JythonShellInter jythonsheller = new JythonShellInter(pStream);
            setShellInter(jythonsheller);
        } else if (ParserName.equals("groovy")) {
            GroovyShellInter groovyShellInter = new GroovyShellInter(pStream);
